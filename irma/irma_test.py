#!/home/vla/ArrestedDevelopment/sndbx/v-filch/bin/python3
...
for day in range(2,4):
	...
	test = TestLibrary()
	print(f"\n\n\n{test.timing()}")
	# test.loggy._handler.close()
	test.library_shelf.produce(rewrite=True, strict_mode=False)
